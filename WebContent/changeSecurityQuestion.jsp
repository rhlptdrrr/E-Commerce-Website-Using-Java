...
<h3>Select Your New Securtiy Question</h3>
  <select style="border-radius: 10px;background-color: #1a222d;color:white;" class="input-style" name="securityQuestion">
 ...
 <input style="border-radius: 10px;background-color: #1a222d;color:white;" class="input-style" type="text" name="newAnswer" placeholder="Enter Your New Answer" required>
<br>
